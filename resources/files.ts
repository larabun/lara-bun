...
// load this module — and because nothing in `rsc-router/host` imports it, a
// bundle for one of them contains no reference to `node:fs` at all.
//
//   import { createRscHandler } from 'rsc-router/host'
//   import { assetsFrom, prerenderedFrom } from 'rsc-router/files'
//
//   createRscHandler({
//     engine,
