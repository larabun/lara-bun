...
import { isReachable, reportReachable } from '../../resources/js/onlineStore.ts'
import { useOnline, useOffline } from '../../resources/js/useOnline.ts'
import {
  navigate,
  prefetch,
  cancelPrefetch,
...
describe('the hook', () => {
  ...
  test('an unchanged outcome does not notify', async () => {
    ...
    let notifications = 0
    const stop = (await import('../../resources/js/onlineStore.ts')).subscribeReachable(() => {
      notifications++
    })
